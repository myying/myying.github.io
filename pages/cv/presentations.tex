\begin{enumerate}
\item \textbf{Ying, Y.},
\textit{``New features in NEDAS v1.2.0 and applications in geophysical data assimilation''},
21st International EnKF Workshop, Jun 18, 2026

\item \textbf{Ying, Y.},
\textit{``Advancing multiscale and non-Gaussian data assimilation methodology for geophysical models''},
STOCHASTICA Directions Workshop, Apr 28, 2026
